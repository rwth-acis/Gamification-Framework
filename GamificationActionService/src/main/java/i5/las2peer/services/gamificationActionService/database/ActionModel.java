...
public class ActionModel {
	...
	@ApiModelProperty(value = "Type of action")
	private String lrsAttribute;

	@ApiModelProperty(value = "Type of action")
	private String lrsAttributeValue;

	public String getLrsAttributeValue() {
		return lrsAttributeValue;
	}

	public void setLrsAttributeValue(String lrsAttributeValue) {
		this.lrsAttributeValue = lrsAttributeValue;
	}

	public String getLrsAttribute() {
		return lrsAttribute;
	}

	public void setLrsAttribute(String lrsAttribute) {
		this.lrsAttribute = lrsAttribute;
	}
	...
	public ActionModel(String action_id, String name, String description, int point_value, boolean use_notification,
	...
	public ActionModel(String action_id, String name, String description, int point_value, boolean use_notification,
			String notif_message, String type, String lrsOccString, String lrsAttribute, String lrsAttributeValue) {
		this.action_id = action_id;
		this.name = name;
		this.description = description;
		this.point_value = point_value;

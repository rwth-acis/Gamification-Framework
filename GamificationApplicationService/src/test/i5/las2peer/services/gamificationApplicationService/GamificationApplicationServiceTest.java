...
public class GamificationApplicationServiceTest {
...
//	private static final int HTTP_PORT = WebConnector.DEFAULT_HTTP_PORT;
	...
	public void testA3_removeMemberFromApp()
	{
		...
		try
		{
			...
			ClientResponse result = c1.sendRequest("DELETE",  mainPath + "data/"+appId+"/"+memberId, ""); // testInput is
			System.out.println(result.getResponse());
			assertEquals(200, result.getHttpCode());
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void testA4_addMemberToApp()
	{
		...
		try
		{
			...
			ClientResponse result = c2.sendRequest("POST",  mainPath + "data/"+appId+"/"+memberId, ""); // testInput is
			System.out.println(result.getResponse());
			assertEquals(200, result.getHttpCode());
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void testA4_getAppWithId(){
		...
		try
		{
			ClientResponse result = c1.sendRequest("GET",  mainPath + "data/" + appId, "");
	        assertEquals(HttpURLConnection.HTTP_OK, result.getHttpCode());
		} catch (Exception e)
		{
			e.printStackTrace();
	...
	public void testZ9_deleteApp(){
		...
		try
		{
			ClientResponse result = c1.sendRequest("DELETE",  mainPath + "data/" + appId, "");
	        assertEquals(HttpURLConnection.HTTP_OK, result.getHttpCode());
		} catch (Exception e)
		{
			e.printStackTrace();
	...
	{
		GamificationApplicationService cl = new GamificationApplicationService();

...
BadgeDAO.prototype.getBadgesData = function(successCallback, errorCallback){
	currentAppId = Cookies.get("appid");
	var endPointURL = "gamification/badges/"+currentAppId;
	var query = "?current=1&rowCount=-1&searchPhrase=";
	ClientHelper.getData(endPointURL+query,successCallback, errorCallback);
}
...
BadgeDAO.prototype.deleteBadge = function(useNotification,successCallback, errorCallback, badgeid){
	currentAppId = Cookies.get("appid");
	var path_URI = "gamification/badges/"+currentAppId+"/" + badgeid;

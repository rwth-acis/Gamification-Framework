...
startService\(\'i5.las2peer.services.gamificationApplicationService.GamificationApplicationService@0.1\',\'gamificationapplicationpass\'\) startWebConnector interactive

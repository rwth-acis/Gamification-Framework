...
java -cp "lib/*:service/*" i5.las2peer.tools.L2pNodeLauncher -p 9114 -b 137.226.232.171:9010 --observer --observer --observer --observer --observer --observer --observer --observer uploadStartupDirectory\(\'etc/startup\'\) \

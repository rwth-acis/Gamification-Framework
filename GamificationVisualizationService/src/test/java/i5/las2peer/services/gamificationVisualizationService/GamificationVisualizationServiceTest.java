...
import i5.las2peer.services.gamificationStreakService.GamificationStreakService;
...
public class GamificationVisualizationServiceTest {
	...
	public void testc6_getMemberStreaks()
	{
		...
		try
		{
			ClientResponse result = c1.sendRequest("GET", mainPath + "streaks/" + appId + "/" + memberId, ""); // testInput is
			System.out.println(result.getResponse());
			assertEquals(200, result.getHttpCode());
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void testC7_getStreakDetailWithId()
	{
		...
		try
		{
			ClientResponse result = c1.sendRequest("GET", mainPath + "streaks/"+appId+"/"+memberId+"/"+streakId, ""); // testInput is
			System.out.println(result.getResponse());
			assertEquals(200, result.getHttpCode());
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void testC8_getStreakProgressOfMember()
	{
		...
		try
		{
			ClientResponse result = c1.sendRequest("GET", mainPath + "streaks/"+appId+"/"+memberId+"/progress/" +  streakId, ""); // testInput is
			System.out.println(result.getResponse());
			assertEquals(200, result.getHttpCode());
		} catch (Exception e) {
			e.printStackTrace();

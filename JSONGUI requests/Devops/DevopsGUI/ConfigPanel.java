...
public final class ConfigPanel extends JPanel{
	...
	private ConfigPanel(){
		...
		cons.insets = new Insets(5,5,5,5);
		cons.gridx = cons.gridy = 0;
		JButton nextBtn = new JButton("Next (Add game and member)");
		nextBtn.addActionListener(e -> DevopsModelGUI.getInstance().setCurrentPanel(GameMemberPanel.getInstance()));

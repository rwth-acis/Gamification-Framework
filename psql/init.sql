...
INSERT INTO manager.game_info(game_id, description, community_type) VALUES('testSuccess', 'desc', 'com_type');

SELECT create_new_game('testSuccess');

INSERT INTO manager.member_info (member_id,first_name,last_name,email) VALUES ('MemberSuccessTest','test','test','test@test.com') ON CONFLICT DO NOTHING;

SELECT init_member_to_game('MemberSuccessTest','testSuccess');



INSERT INTO manager.game_info(game_id, description, community_type) VALUES('testDevops', 'desc', 'com_type');

SELECT create_new_game('testDevops');

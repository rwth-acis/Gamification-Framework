...
java -cp %CLASSPATH% i5.las2peer.tools.L2pNodeLauncher -w -p 9022 -b 192.168.56.1:9011 uploadStartupDirectory('etc/startup')^
 startService('i5.las2peer.services.gamificationDevopsService.GamificationDevopsService@0.1','gamificationdevopspass') interactive
 pause
